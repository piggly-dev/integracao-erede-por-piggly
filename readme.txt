=== e-Rede por Piggly (para Woocommerce) ===
...
Veja o arquivo [CHANGELOG](https://github.com/piggly-dev/woo-erede-por-piggly/CHANGELOG.md) para informações sobre todas as mudanças no código.

== Desenvolvimento ==

Veja o arquivo [CONTRIBUTING](https://github.com/piggly-dev/woo-erede-por-piggly/CONTRIBUTING.md) para todas as informações a respeito das regras de conduta do desenvolvimento e organização do código.

== Créditos ==

- [Caique Araujo](https://github.com/caiquearaujo)
- [Piggly Lab](https://github.com/piggly-dev)
- [Todos os desenvolvedores](https://github.com/piggly-dev/woo-erede-por-piggly/graphs/contributors)

== Licenciamento ==

GNU GENERAL PUBLIC LICENSE (GNU v3). Veja [LICENSE](https://github.com/piggly-dev/woo-erede-por-piggly/LICENSE).