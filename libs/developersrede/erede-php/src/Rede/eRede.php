...
use Piggly\WooERedeGateway\Vendor\Rede\Service\CancelTransactionService;
use Piggly\WooERedeGateway\Vendor\Rede\Service\CaptureTransactionService;
use Piggly\WooERedeGateway\Vendor\Rede\Service\CreateTransactionService;
use Piggly\WooERedeGateway\Vendor\Rede\Service\GetTransactionService;
class eRede
{
    const VERSION = '5.1.2';
    ...
    public function getRefunds($tid)
    {
        ...
        $getTransactionService->platform($this->platform, $this->platformVersion);
        $getTransactionService->setTid($tid);
        $getTransactionService->setRefund(\true);
        return $getTransactionService->execute();
    }
    /**
     * @param Transaction $transaction
