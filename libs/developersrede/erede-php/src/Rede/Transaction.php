...
class Transaction implements RedeSerializable, RedeUnserializable
{
    ...
    {
        return $this->setCard($cardNumber, $cardCvv, $expirationMonth, $expirationYear, $holderName, Transaction::CREDIT);
    }
    /**
     * @param $cardNumber
     * @param $securityCode
    ...
    {
        $this->capture(\true);
        return $this->setCard($cardNumber, $cardCvv, $expirationMonth, $expirationYear, $holderName, Transaction::DEBIT);
    }
    /**
     * @param bool $capture
     *
     * @return Transaction
     */
    public function capture($capture = \true)
    {
    ...
    public function jsonSerialize()
    {
        ...
        return \array_filter(['capture' => $capture, 'cart' => $this->cart, 'kind' => $this->kind, 'threeDSecure' => $this->threeDSecure, 'reference' => $this->reference, 'amount' => $this->amount, 'installments' => $this->installments, 'cardHolderName' => $this->cardHolderName, 'cardNumber' => $this->cardNumber, 'expirationMonth' => $this->expirationMonth, 'expirationYear' => $this->expirationYear, 'securityCode' => $this->securityCode, 'softDescriptor' => $this->softDescriptor, 'subscription' => $this->subscription, 'origin' => $this->origin, 'distributorAffiliation' => $this->distributorAffiliation, 'storageCard' => $this->storageCard, 'urls' => $this->urls, 'iata' => $this->iata, 'additional' => $this->additional], function ($value) {
     ...
     * @return Transaction
     */
    public function threeDSecure($onFailure = ThreeDSecure::DECLINE_ON_FAILURE, $embed = \true, $directoryServerTransactionId = "", $threeDIndicator = "1")
    {
        $threeDSecure = new ThreeDSecure();
