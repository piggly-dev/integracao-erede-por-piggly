...
use Piggly\WooERedeGateway\Vendor\Monolog\Formatter\LineFormatter;
use Piggly\WooERedeGateway\Vendor\Monolog\Formatter\FormatterInterface;
use Piggly\WooERedeGateway\Vendor\Monolog\Logger;
use Piggly\WooERedeGateway\Vendor\Monolog\Utils;
use Piggly\WooERedeGateway\Vendor\PhpConsole\Connector;
use Piggly\WooERedeGateway\Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use Piggly\WooERedeGateway\Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['Piggly\\WooERedeGateway\\Vendor\\Monolog\\'],
    ...
    {
        if (!\class_exists('Piggly\\WooERedeGateway\\Vendor\\PhpConsole\\Connector')) {
